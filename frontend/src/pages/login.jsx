      ...
      <style>{`
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .biblio-page {
          ...
          background-image:
            radial-gradient(ellipse at 20% 20%, rgba(194,122,96,0.08) 0%, transparent 60%),
        ...
        .field-input.focused { border-color: var(--accent-soft); }
        ...
        .register-prompt a:hover { color: var(--accent-hover); }
